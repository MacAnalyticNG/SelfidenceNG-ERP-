...
export function EditOrderForm({ order, customers, services, onSuccess }: EditOrderFormProps) {
    ...
    const [selectedServices, setSelectedServices] = useState<OrderItem[]>(
        order.items.map(item => ({
            ...
            serviceName: services.find(s => s.id === item.serviceId)?.name || item.serviceName || "Unknown Service"
        }))
    )
    ...
    const handleAddService = (serviceId: string) => {
        ...
        setSelectedServices((prev) => {
            ...
            return [...prev, { serviceId, quantity: 1, unitPrice: service.price, serviceName: service.name }]
        })
    }
    ...
    if (state.success) {
        ...
        return (
            <div className="flex flex-col items-center justify-center py-6 space-y-4">
                <p className="text-green-600 font-medium">Order updated successfully!</p>
            </div>
        )
    }
                ...
                <TabsContent value="details" className="space-y-4 py-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select name="priority" defaultValue={order.priority.toLowerCase()}>
                                <SelectTrigger>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                name="pickupDate"
                                type="date"
                                defaultValue={order.pickupDate.split('T')[0]}
                                required
                            />
                        </div>
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                name="dueDate"
                                type="date"
                                defaultValue={order.dueDate.split('T')[0]}
                                required
                            />
                        </div>
